...
LOCAL_OVERRIDES_PACKAGES := AdaptiveVPNPrebuilt AudioFX
...
LOCAL_OVERRIDES_PACKAGES += MaestroPrebuilt Music MusicFX 
LOCAL_OVERRIDES_PACKAGES += NgaResources
LOCAL_OVERRIDES_PACKAGES += Gallery2 GoogleTTS Photos PhotoTable PicoTts
